package com.devcommunity.platform.service.config.service.impl;

import com.devcommunity.platform.api.model.event.ConfigRefreshEvent;
import com.devcommunity.platform.api.model.exception.ExceptionUtil;
import com.devcommunity.platform.api.model.vo.PageVo;
import com.devcommunity.platform.api.model.vo.config.GlobalConfigReq;
import com.devcommunity.platform.api.model.vo.config.SearchGlobalConfigReq;
import com.devcommunity.platform.api.model.vo.config.dto.GlobalConfigDTO;
import com.devcommunity.platform.api.model.vo.constants.StatusEnum;
import com.devcommunity.platform.core.senstive.SensitiveProperty;
import com.devcommunity.platform.core.senstive.SensitiveService;
import com.devcommunity.platform.core.util.NumUtil;
import com.devcommunity.platform.core.util.SpringUtil;
import com.devcommunity.platform.service.config.converter.ConfigStructMapper;
import com.devcommunity.platform.service.config.repository.dao.ConfigDao;
import com.devcommunity.platform.service.config.repository.entity.GlobalConfigDO;
import com.devcommunity.platform.service.config.repository.params.SearchGlobalConfigParams;
import com.devcommunity.platform.service.config.service.GlobalConfigService;
