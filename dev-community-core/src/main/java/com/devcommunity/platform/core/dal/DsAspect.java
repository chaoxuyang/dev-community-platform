package com.devcommunity.platform.core.dal;
...
public class DsAspect {
     ...
     */
    @Pointcut("@annotation(com.devcommunity.platform.core.dal.DsAno) || @within(com.devcommunity.platform.core.dal.DsAno)")
